...
const ToothReportSchema = new mongoose_1.Schema({
    user: {
...
const ToothReportModel = mongoose_1.default.model("ToothReport", ToothReportSchema);
exports.default = ToothReportModel;
