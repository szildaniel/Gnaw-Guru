const resetPassword = function (link:string, name:string) {
  const html = `
    <!DOCTYPE html>
                  ...
                  <tr>
                    <td class="sm-px-24"
                      ...
                      <p style="margin: 0 0 16px;">
                        ...
                        <a href="mailto:gnawguru@gmail.com" class="hover-underline"
                          style="--text-opacity: 1; color: #7367f0; text-decoration: none;">gnawguru@gmail.com</a>.
                      </p>
                    </td>
                  </tr>
                  <tr>
